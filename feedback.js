...
(
	function() {
		...
		*****************************************/
		...
		this.addPosFeedback = function(e, text, msg, title) { baseAddItem(e, 'check', text, 'main', function() { 
			feedback.createNotification(msg, title);  
			feedback.removeItemsInSet(e, 'main');
		} ); }
		this.addNegFeedback = function(e, text, msgboxTitle, msgBoxCharLimit, notifyTitle) { baseAddItem(e, 'times', text, 'main',
			function() {
				feedback.createMessageBox(e, msgboxTitle, msgBoxCharLimit, 
					function(msg) { 
						feedback.createNotification(msg, notifyTitle); 
					} 
				); 
			}
		); }
		this.addMsgFeedback = function(e, text, callback) { baseAddItem(e, 'envelope', text, '', callback); }
